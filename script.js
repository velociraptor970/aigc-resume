...
const themeDetails = {
  pipeline: {
    ...
    copy: "把项目美术需求、风格参考、模型选择、节点参数、输出规范和复用说明组织成团队可调用的 AIGC 美术生产流程，核心目标是提升资产生产效率和结果稳定性。",
    keywords: "项目美术需求、ComfyUI、LoRA、公共平台、10+ 工作流、团队复用",
    proof: "公共平台截图、工作流列表、项目反馈截图、节点截图、生成前后对比",
  },
  asset: {
  ...
  pbr: {
    ...
    copy: "针对项目素材的阴影与空间层次需求，结合 Blender 场景数据和 AI 辅助流程完成阴影/AO 烘焙与对齐输出，让 2D 素材获得更稳定的体积和光影表现。",
    keywords: "Blender + AI 阴影烘焙、AO、空间层次、1 天交付、超越预期",
    proof: "需求记录、烘焙前后对比、PSD/输出文件、组长反馈截图",
  },
  engine: {
    title: "软边缘抠图与硬边缘抠图工作流",
    copy: "针对毛发、半透明边缘、动画素材边缘脏和批量处理慢等问题，搭建软边缘抠图与硬边缘抠图流程，支持项目长期抠图动画需求并沉淀为可复用方案。",
    keywords: "软边缘抠图、硬边缘抠图、毛发、半透明边缘、动画素材、长期稳定",
    proof: "公共平台卡片、抠图前后对比、动画素材案例、项目好评截图",
  },
  tooling: {
    title: "PS-AI 美术工具方向验证与功能规划",
    copy: "基于 PS-AI 插件实践和项目协作经验，围绕局部重绘、AI 生图降噪、软/硬边缘抠图等真实美术需求梳理功能方向，并协助完成工作流接入与效果验证。",
    keywords: "PS-AI、局部重绘、AI 生图降噪、功能规划、真实美术需求",
    proof: "插件演示视频、功能原型、工作流截图、mentor/组长反馈",
  },
  li3d: {
    title: "Li3D 贴图绘制管线重构与上线",
    copy: "负责 Li3D 贴图绘制流程的重构与效果验证，对标 3D AI 贴图能力，搭建 Flux2 Klein TrueV3 双图材质编辑工作流，并接入贴图保存与输出链路。",
