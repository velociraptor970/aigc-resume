...
const themeDetails = {
  pipeline: {
    title: "公共平台工作流上线结果",
    copy: "2026.04-08 持续 5 个月上线 10+ 个项目定制工作流，覆盖 6 类生产场景；上线后产生项目复用、跨组咨询、追加定制和明确正向反馈。使用人数、调用次数、使用占比可通过平台后台补充验证。",
    keywords: "5 个月、10+ 工作流、6 类生产场景、多组复用、单批几十到上百张、约 1 天交付、项目反馈",
