...
const themeDetails = {
  pipeline: {
    title: "从主美标准到管线落地",
    copy: "这部分最贴合 JD：研究 AIGC 在游戏研发管线中的应用，把美术方向、项目需求和技术验证连接成可复用的生产方案。",
    keywords: "主美/项目需求转译、ComfyUI、流程复现、团队复用、生产验证",
    proof: "流程文档、节点截图、输出对比、筛选维度、入引擎验收结果",
  },
  asset: {
  ...
  pbr: {
    ...
    copy: "PBR 相关内容可以作为面试补强点：说明 Base Color、Roughness、Metallic、Normal、AO 对最终材质表现的影响。",
    keywords: "PBR 通道、材质节点、灯光验证、贴图清晰度",
    proof: "PBR 视频总结、材质测试截图、Blender 渲染对比",
  },
  engine: {
    title: "把生成结果放进引擎里说话",
    copy: "AO/Depth、软边缘抠图、透明资源和地图空间感都可以连接到引擎表现，证明你关注最终上线效果，而不是只停留在生成图。",
    keywords: "AO/Depth、透明边缘、Unity / UE5、视觉稳定性、性能成本",
    proof: "地图烘焙文档、Depth/AO 输出、入引擎效果验证",
  },
  tooling: {
    title: "把复杂流程变成别人能用的工具",
    copy: "PS-AI 插件和流程说明不一定难在算法，而难在落地价值：降低美术调用门槛，让团队可以稳定复用。",
