...
const themeDetails = {
  pipeline: {
    title: "公共平台工作流上线数据",
    copy: "把项目定制工作流沉淀到公共平台后，按使用周期、覆盖场景、复用反馈和后续咨询记录效果：2026.04-08 已确认 10+ 个工作流进入平台，覆盖 6 类生产场景，并产生项目复用、跨组咨询和追加定制需求。",
    keywords: "2026.04-08、10+ 工作流、6 类生产场景、项目复用、跨组咨询、追加定制需求",
